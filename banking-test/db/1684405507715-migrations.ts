...
export class Migrations1684405507715 implements MigrationInterface {
    name = 'Migrations1684405507715'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "category_transaction" ADD CONSTRAINT "FK_cf7c4b979fe086f5e6a687f7a0c" FOREIGN KEY ("transactionId") REFERENCES "transaction"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "category_transaction" ADD CONSTRAINT "FK_193e5d0c0fd2c3f4d1e8714efb8" FOREIGN KEY ("categoryId") REFERENCES "category"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
    }
